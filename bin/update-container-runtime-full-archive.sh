...
nerdctl_version=$(${PROJECT_ROOT}/downloads/temp/bin/nerdctl --version | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')
buildkit_version=$(${PROJECT_ROOT}/downloads/temp/bin/buildkitd --version | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')
containerd_version=$(${PROJECT_ROOT}/downloads/temp/bin/containerd --version | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')
cni_plugins_version=$(${PROJECT_ROOT}/downloads/temp/libexec/cni/bridge --version 2>&1 | head -1 | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')
runc_version=$(${PROJECT_ROOT}/downloads/temp/bin/runc --version | head -1 | grep -o '[0-9]\+\.[0-9]\+\.[0-9]\+')
