...
truncate -s 0 "${OS_FILE}"
{
    ...
    echo ""
    echo "# From https://dl.fedoraproject.org/pub/fedora/linux/releases/41/Cloud/aarch64/images/"
    echo "AARCH64_ARTIFACT=$(basename "${aarch64_deps}")"
    echo "AARCH64_512_DIGEST=${aarch64_deps_shasum}"
    echo ""
    echo "# From https://dl.fedoraproject.org/pub/fedora/linux/releases/41/Cloud/x86_64/images/"
