...
ifneq (,$(findstring arm64,$(ARCH)))
	LIMA_ARCH = aarch64
	LIMA_URL ?= https://deps.runfinch.com/aarch64/lima-and-qemu.macos-aarch64.1713261406.tar.gz
	...
	LIMA_ARCH = x86_64
	LIMA_URL ?= https://deps.runfinch.com/x86-64/lima-and-qemu.macos-x86_64.1713261406.tar.gz
